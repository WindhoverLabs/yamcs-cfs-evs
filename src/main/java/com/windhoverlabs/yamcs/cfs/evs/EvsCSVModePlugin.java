...
public class EvsCSVModePlugin implements Plugin {
  private static final Log log = new Log(EvsCSVModePlugin.class);
  ...
  public void onLoad(YConfiguration config) throws PluginException {
    ...
    httpServer.addApi(new org.yamcs.http.api.CSVModeAPI());
  }
